...
const CharacterComparison = () => {
  ...
  const handleNavigate = () => {
    navigate("/emotionalgraph"); // Go to /emotionalgraph
  };
  ...
  return (
    <div className="comparison-container">
      ...
      <table className="comparison-table">
        <tbody>
          ...
          <tr>
            ...
            <td>This isn’t love. It’s a karmic mirror to end self-betrayal</td>
            <td>This isn’t silence. It’s a spiritual pause to reclaim voice</td>
          </tr>
        </tbody>
      </table>
      ...
      <div className="summary">
        ...
        <p>
          They were not women to possess, but mirrors meant to break my cycles.
          One through noise. The other through quiet.
        </p>
        <blockquote className="quote">
          I sought affection from where love never lived. Now I return home — to
          the heart that always waited: mine.
        </blockquote>
        <h3>Solution</h3>
        <blockquote className="quote">
          The true healing lies not in winning their affection or decoding their
          coldness, but in honoring the part of you that kept reaching. Reclaim
          that energy. Romantic love is not a test of endurance. It is a mirror
          of self-respect. You don't chase what's sacred — you become it.
        </blockquote>

        <h3>Neville Goddard Interpretation</h3>
        <blockquote className="quote">
          Both women reflect your state of consciousness at the time you met
          them. Sumbal is the projection of desire chased externally. Shemiala,
          the absence within, manifesting as silence. Heal by revising the inner
          self-concept — they were never causes, only reflections.
        </blockquote>
        ...
        <ul>
          ...
          <li>What part of me still believes I must earn love through pain?</li>
          <li>
